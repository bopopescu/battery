...
class BigTestInfoTable(models.Model):
    ...
    AIRID = models.ForeignKey(AIRDeviceTable, to_field='ID', verbose_name="AIRID", on_delete=models.CASCADE, blank=True,
                              null=True)
    wdjID = models.ForeignKey(wdjDeviceTable, to_field='ID', verbose_name="wdj0ID", on_delete=models.CASCADE,
                              blank=True,
                              null=True)
...
class cellTestRealDataTable(models.Model):
    ...
    boxID = models.ForeignKey(boxDeviceTable, to_field='ID', verbose_name="箱号", on_delete=models.CASCADE, null=True,
                              blank=True)
    chnNum = models.IntegerField(verbose_name="通道号", null=True, blank=True)
    # 测试ID，区别于测试方案ID
    ...
    testID = models.ForeignKey(testInfoTable, to_field='id', verbose_name="testID", on_delete=models.CASCADE,
                               blank=True, null=True)
    # 测试方案信息
    totalStepN = models.IntegerField(verbose_name="总工步数", blank=True, null=True)
    currState = models.CharField(choices=(("stop", "停止"), ("pause", "暂停"), ("start", "启动"), ("resume", "继续")),
    ...
    # 电池运行状态信息
    conState = models.IntegerField(verbose_name="联机状态", blank=True, null=True)
    chState = models.IntegerField(verbose_name="通道状态", blank=True, null=True)
    chStateCode = models.IntegerField(verbose_name="通道异常代码", blank=True, null=True)

    chMasterSlaveFlag = models.IntegerField(verbose_name="通道主从标志", blank=True, null=True)
    n = models.IntegerField(verbose_name="当前工步号", blank=True, null=True)  #
    k = models.IntegerField(verbose_name="当前过程号", blank=True, null=True)  #
    mode = models.IntegerField(verbose_name="工作模式", blank=True, null=True)  #

    tc = models.IntegerField(verbose_name="本工步已工作时间", blank=True, null=True)  # ms
    ta = models.IntegerField(verbose_name="本工步累计时间", blank=True, null=True)

    i = models.IntegerField(verbose_name="实时电流", blank=True, null=True)  # uA
    u = models.IntegerField(verbose_name="实时电压", blank=True, null=True)  # mV
    q = models.IntegerField(verbose_name="实时容量", blank=True, null=True)  #
    qA = models.IntegerField(verbose_name="累计容量", blank=True, null=True)  #
    T = models.IntegerField(verbose_name="当前温度", blank=True, null=True)  #
    r = models.IntegerField(verbose_name="当前内阻", blank=True, null=True)  #

    detailDataFlag = models.IntegerField(verbose_name="是否有明细数据", blank=True, null=True)
    resultDataFlag = models.IntegerField(verbose_name="是否有结果数据", blank=True, null=True)
    overOutDataFlag = models.IntegerField(verbose_name="是否有数据溢出", blank=True, null=True)
    powerDownFlag = models.IntegerField(verbose_name="是否有设备断电", blank=True, null=True)

    celldata_time = models.DateTimeField(verbose_name="电池数据修改时间", blank=True, null=True)

    # 流量计信息
    sH2 = models.IntegerField(verbose_name="H2通讯状态", blank=True, null=True)
    qH2 = models.DecimalField(max_digits=8, decimal_places=2, verbose_name="H2流量", blank=True, null=True)
    tH2 = models.DateTimeField(verbose_name="H2数据修改时间", blank=True, null=True)

    sN2 = models.IntegerField(verbose_name="N2通讯状态", blank=True, null=True)
    qN2 = models.DecimalField(max_digits=8, decimal_places=2, verbose_name="N2流量", blank=True, null=True)
    tN2 = models.DateTimeField(verbose_name="N2数据修改时间", blank=True, null=True)

    sCO2 = models.IntegerField(verbose_name="CO2通讯状态", blank=True, null=True)
    qCO2 = models.DecimalField(max_digits=8, decimal_places=2, verbose_name="CO2流量", blank=True, null=True)
    tCO2 = models.DateTimeField(verbose_name="CO2数据修改时间", blank=True, null=True)

    sCH4 = models.IntegerField(verbose_name="CH4通讯状态", blank=True, null=True)
    qCH4 = models.DecimalField(max_digits=8, decimal_places=2, verbose_name="CH4流量", blank=True, null=True)
    tCH4 = models.DateTimeField(verbose_name="CH4数据修改时间", blank=True, null=True)

    sAIR = models.IntegerField(verbose_name="AIR通讯状态", blank=True, null=True)
    qAIR = models.DecimalField(max_digits=8, decimal_places=2, verbose_name="空气流量", blank=True, null=True)
    tAIR = models.DateTimeField(verbose_name="AIR数据修改时间", blank=True, null=True)

    sH2O = models.IntegerField(verbose_name="H2O通讯状态", blank=True, null=True)
    qH2O = models.DecimalField(max_digits=8, decimal_places=2, verbose_name="水流量", blank=True, null=True)
    tH2O = models.DateTimeField(verbose_name="H2O数据修改时间", blank=True, null=True)

    # 温控器信息

    sTc0 = models.IntegerField(verbose_name="Tc0通讯状态", blank=True, null=True)
    Tc0 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度控制点0", blank=True, null=True)
    tTc0 = models.DateTimeField(verbose_name="T0数据修改时间", blank=True, null=True)

    sTc1 = models.IntegerField(verbose_name="Tc1通讯状态", blank=True, null=True)
    Tc1 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度控制点1", blank=True, null=True)
    tTc1 = models.DateTimeField(verbose_name="T1数据修改时间", blank=True, null=True)

    sTc2 = models.IntegerField(verbose_name="Tc2通讯状态", blank=True, null=True)
    Tc2 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度控制点2", blank=True, null=True)
    tTc2 = models.DateTimeField(verbose_name="T2数据修改时间", blank=True, null=True)

    sTc3 = models.IntegerField(verbose_name="Tc3通讯状态", blank=True, null=True)
    Tc3 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度控制点3", blank=True, null=True)
    tTc3 = models.DateTimeField(verbose_name="T3数据修改时间", blank=True, null=True)

    # 温度巡检仪信息
    Tm0 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点0", blank=True, null=True)
    tTm0 = models.DateTimeField(verbose_name="T0数据修改时间", blank=True, null=True)
    Tm1 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点1", blank=True, null=True)
    tTm1 = models.DateTimeField(verbose_name="T1数据修改时间", blank=True, null=True)
    Tm2 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点2", blank=True, null=True)
    tTm2 = models.DateTimeField(verbose_name="T2数据修改时间", blank=True, null=True)
    Tm3 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点3", blank=True, null=True)
    tTm3 = models.DateTimeField(verbose_name="T3数据修改时间", blank=True, null=True)
    Tm4 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点4", blank=True, null=True)
    tTm4 = models.DateTimeField(verbose_name="T4数据修改时间", blank=True, null=True)
    Tm5 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点5", blank=True, null=True)
    tTm5 = models.DateTimeField(verbose_name="T5数据修改时间", blank=True, null=True)
    Tm6 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点6", blank=True, null=True)
    tTm6 = models.DateTimeField(verbose_name="T6数据修改时间", blank=True, null=True)
    Tm7 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点7", blank=True, null=True)
    tTm7 = models.DateTimeField(verbose_name="T7数据修改时间", blank=True, null=True)
    Tm8 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点8", blank=True, null=True)
    tTm8 = models.DateTimeField(verbose_name="T8数据修改时间", blank=True, null=True)
    Tm9 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点9", blank=True, null=True)
    tTm9 = models.DateTimeField(verbose_name="T9数据修改时间", blank=True, null=True)
    Tm10 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点10", blank=True, null=True)
    tTm10 = models.DateTimeField(verbose_name="T10数据修改时间", blank=True, null=True)
    Tm11 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点11", blank=True, null=True)
    tTm11 = models.DateTimeField(verbose_name="T11数据修改时间", blank=True, null=True)
    Tm12 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点12", blank=True, null=True)
    tTm12 = models.DateTimeField(verbose_name="T12数据修改时间", blank=True, null=True)
    Tm13 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点13", blank=True, null=True)
    tTm13 = models.DateTimeField(verbose_name="T13数据修改时间", blank=True, null=True)
    Tm14 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点14", blank=True, null=True)
    tTm14 = models.DateTimeField(verbose_name="T14数据修改时间", blank=True, null=True)
    Tm15 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点15", blank=True, null=True)
    tTm15 = models.DateTimeField(verbose_name="T15数据修改时间", blank=True, null=True)
    Tm16 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点16", blank=True, null=True)
    tTm16 = models.DateTimeField(verbose_name="T16数据修改时间", blank=True, null=True)
    Tm17 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点17", blank=True, null=True)
    tTm17 = models.DateTimeField(verbose_name="T17数据修改时间", blank=True, null=True)
    Tm18 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点18", blank=True, null=True)
    tTm18 = models.DateTimeField(verbose_name="T18数据修改时间", blank=True, null=True)
    Tm19 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="温度监测点19", blank=True, null=True)
    tTm19 = models.DateTimeField(verbose_name="T19数据修改时间", blank=True, null=True)

    # 电压巡检仪信息
    Vm0 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点0", blank=True, null=True)
    tVm0 = models.DateTimeField(verbose_name="V0数据修改时间", blank=True, null=True)
    Vm1 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点1", blank=True, null=True)
    tVm1 = models.DateTimeField(verbose_name="V1数据修改时间", blank=True, null=True)
    Vm2 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点2", blank=True, null=True)
    tVm2 = models.DateTimeField(verbose_name="V2数据修改时间", blank=True, null=True)
    Vm3 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点3", blank=True, null=True)
    tVm3 = models.DateTimeField(verbose_name="V3数据修改时间", blank=True, null=True)
    Vm4 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点4", blank=True, null=True)
    tVm4 = models.DateTimeField(verbose_name="V4数据修改时间", blank=True, null=True)
    Vm5 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点5", blank=True, null=True)
    tVm5 = models.DateTimeField(verbose_name="V5数据修改时间", blank=True, null=True)
    Vm6 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点6", blank=True, null=True)
    tVm6 = models.DateTimeField(verbose_name="V6数据修改时间", blank=True, null=True)
    Vm7 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点7", blank=True, null=True)
    tVm7 = models.DateTimeField(verbose_name="V7数据修改时间", blank=True, null=True)
    Vm8 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点8", blank=True, null=True)
    tVm8 = models.DateTimeField(verbose_name="V8数据修改时间", blank=True, null=True)
    Vm9 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点9", blank=True, null=True)
    tVm9 = models.DateTimeField(verbose_name="V9数据修改时间", blank=True, null=True)
    Vm10 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点10", blank=True, null=True)
    tVm10 = models.DateTimeField(verbose_name="V10数据修改时间", blank=True, null=True)
    Vm11 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点11", blank=True, null=True)
    tVm11 = models.DateTimeField(verbose_name="V11数据修改时间", blank=True, null=True)
    Vm12 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点12", blank=True, null=True)
    tVm12 = models.DateTimeField(verbose_name="V12数据修改时间", blank=True, null=True)
    Vm13 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点13", blank=True, null=True)
    tVm13 = models.DateTimeField(verbose_name="V13数据修改时间", blank=True, null=True)
    Vm14 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点14", blank=True, null=True)
    tVm14 = models.DateTimeField(verbose_name="V14数据修改时间", blank=True, null=True)
    Vm15 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点15", blank=True, null=True)
    tVm15 = models.DateTimeField(verbose_name="V15数据修改时间", blank=True, null=True)
    Vm16 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点16", blank=True, null=True)
    tVm16 = models.DateTimeField(verbose_name="V16数据修改时间", blank=True, null=True)
    Vm17 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点17", blank=True, null=True)
    tVm17 = models.DateTimeField(verbose_name="V17数据修改时间", blank=True, null=True)
    Vm18 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点18", blank=True, null=True)
    tVm18 = models.DateTimeField(verbose_name="V18数据修改时间", blank=True, null=True)
    Vm19 = models.DecimalField(max_digits=5, decimal_places=1, verbose_name="电压监测点19", blank=True, null=True)
    tVm19 = models.DateTimeField(verbose_name="V19数据修改时间", blank=True, null=True)
...
class cellTestHistoryDataTable(models.Model):
    ...
    celldata_time = models.DateTimeField(verbose_name="电池数据修改时间", null=True, blank=True)
    ...
    tH2 = models.DateTimeField(verbose_name="H2数据修改时间", null=True, blank=True)
    ...
    tN2 = models.DateTimeField(verbose_name="N2数据修改时间", null=True, blank=True)
    ...
    tCO2 = models.DateTimeField(verbose_name="CO2数据修改时间", null=True, blank=True)
    ...
    tCH4 = models.DateTimeField(verbose_name="CH4数据修改时间", null=True, blank=True)
    ...
    tAIR = models.DateTimeField(verbose_name="AIR数据修改时间", null=True, blank=True)
    ...
    tH2O = models.DateTimeField(verbose_name="H2O数据修改时间", null=True, blank=True)
